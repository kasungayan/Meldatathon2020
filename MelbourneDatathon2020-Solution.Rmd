...
Training period: **2017 Jan - 2020 Aug**, Test period: **2020 Sept** , and *Mean Absolute Scaled Error (MASE)*, *Root Mean Square Error (RMSE)* are used as the primary evaluation metrices. Please refer to [[5]](https://github.com/kasungayan/Meldatathon2020/MelbourneDatathon2020-AdditionalAnalysis.pdf) or [[7]] (https://github.com/kasungayan/Meldatathon2020/MelHack-Additional.html) for the detailed explaination of the experimental setup (external variables, model selection, residual analysis)
...
[5] [Detailed Analysis (PDF)](https://github.com/kasungayan/Meldatathon2020/MelbourneDatathon2020-AdditionalAnalysis.pdf)

[6] [feasts Package](https://cran.r-project.org/web/packages/feasts/index.html)

[7] [Detailed Analysis (HTML)](https://github.com/kasungayan/Meldatathon2020/MelHack-Additional.html)
